        ...
        server.registerTool(
            "vm_create",
            {
                ...
                inputSchema: z.object({
                    ...
                    vcpu: z.number().int().describe("Number of vCPUs"),
                    ram_mb: z.number().int().describe("RAM in MB"),
                    ...
                    os_variant: z.string().optional().describe("OS variant (e.g. ubuntu22.04)")
                })
            },
            async (args) => {
                try {
                ...
                try {
                    ...
                    return {
                        content: [{ type: "text", text: `Error creating VM: ${e.message || e.stderr || e}` }],
                        isError: true
                    };
                }
                return {
